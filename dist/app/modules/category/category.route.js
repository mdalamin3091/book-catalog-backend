...
router.post("/", (0, auth_1.auth)(client_1.UserRole.ADMIN), (0, validationRequest_1.default)(category_validation_1.categoryValidation.create), category_controller_1.categoryController.createCategory);
